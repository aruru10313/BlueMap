<template>
  <div class="control-bar">
    ...
    <div class="space thin-hide"></div>
    <SvgButton v-if="showMapMenu && $bluemap.blockManager" class="thin-hide" title="실시간 블록 / 타임랩스" @action="$bluemap.blockManager.toggleTimelapse()">
      <svg viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm.5-13H11v6l5.2 3.2.8-1.3-4.5-2.7V7z"/>
      </svg>
    </SvgButton>
    <div class="space thin-hide" v-if="showMapMenu && $bluemap.blockManager"></div>
